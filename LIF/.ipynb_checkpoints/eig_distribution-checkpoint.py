...
def main():
    ...
    for k in [0.0, 1.0, 1.5, 2.5, 5.0]:
        ...
        input_folder1 = "/mnt/corr_matrices/LIF/shapes/K_{}".format(k)
        output_folder1 = "/mnt/eig_distributions/LIF/shapes/K_{}".format(k)
        os.makedirs(output_folder1, exist_ok=True)

        input_folder2 = "/mnt/corr_matrices/LIF/spike_trains/K_{}".format(k)
        output_folder2 = "/mnt/eig_distributions/LIF/spike_trains/K_{}".format(k)
        ...
        print("\tExtracting shapes files...", end="\r")
        ...
        pdf_100_emp = eig_distribution(file_list_100, input_folder1)
        pdf_100_emp.to_csv(os.path.join(output_folder1,'pdf_100.csv'), header=True)
            
        print('\tInterpolating n = 200...', end="\r")
        pdf_200_emp = eig_distribution(file_list_200, input_folder1)
        pdf_200_emp.to_csv(os.path.join(output_folder1,'pdf_200.csv'), header=True)
            
        print('\tInterpolating n = 500...', end="\r")
        pdf_500_emp = eig_distribution(file_list_500, input_folder1)
        pdf_500_emp.to_csv(os.path.join(output_folder1,'pdf_500.csv'), header=True)
            
        print('\tInterpolating n = 1000...', end="\r")
        pdf_1000_emp = eig_distribution(file_list_1000, input_folder1)
        pdf_1000_emp.to_csv(os.path.join(output_folder1,'pdf_1000.csv'), header=True)
        ...
        print("\tExtracting spike_trains files...", end="\r")
        ...
        print('\tInterpolating n = 100...', end="\r")
        pdf_100_emp = eig_distribution(file_list_100, input_folder2)
        pdf_100_emp.to_csv(os.path.join(output_folder2,'pdf_100.csv'), header=True)
            
        print('\tInterpolating n = 200...', end="\r")
        pdf_200_emp = eig_distribution(file_list_200, input_folder2)
        pdf_200_emp.to_csv(os.path.join(output_folder2,'pdf_200.csv'), header=True)
            
        print('\tInterpolating n = 500...', end="\r")
        pdf_500_emp = eig_distribution(file_list_500, input_folder2)
        pdf_500_emp.to_csv(os.path.join(output_folder2,'pdf_500.csv'), header=True)
            
        print('\tInterpolating n = 1000...', end="\r")
        pdf_1000_emp = eig_distribution(file_list_1000, input_folder2)
        pdf_1000_emp.to_csv(os.path.join(output_folder2,'pdf_1000.csv'), header=True)
