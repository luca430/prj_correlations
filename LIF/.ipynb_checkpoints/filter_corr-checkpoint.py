...
def main():
    ...
    for k in [0.0, 1.0, 1.5, 2.5, 5.0]:
        ...
        output_folder1 = "/mnt/filtered_matrices/LIF/shapes/K_{}".format(k)
        os.makedirs(output_folder1, exist_ok=True)

        input_folder2 = "/mnt/corr_matrices/LIF/spike_trains/K_{}".format(k)
        output_folder2 = "/mnt/filtered_matrices/LIF/spike_trains/K_{}".format(k)
